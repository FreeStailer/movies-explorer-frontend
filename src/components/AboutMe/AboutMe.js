      ...
      <div className="about-me__info">
        <div className="about-me__text">
          ...
          <p className="about-me__description">
            ...
            Очень много приходится с работой сайтов, но сделать ранее ничего
            не мог, а Практикум помог сделать невероятное.
          </p>
          <div className="about-me__social">
            <a
              href="https://www.facebook.com/aleksey.suslin/"
              className="about-me__link"
            >
              Facebook
            </a>
            <a href="https://github.com/freestailer" className="about-me__link">
              Github
            </a>
          </div>
        </div>
